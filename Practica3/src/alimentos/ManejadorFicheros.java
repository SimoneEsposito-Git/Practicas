...
public class ManejadorFicheros {
    ...
    /**
     * Funcion que lee un ingrediente desde una linea
     * 
     * @param line la linea para leer
     * @return un ingrediente al leer de la linea
     */
    ...
    /**
     * Lee un plato de una linea
     * 
     * @param line linea de texto para leer
     * @param ingredientes un mapa de ingredientes para sacar
     * @return el plato que se ha leido de la linea
     */
    ...
    /**
     * Lee un menu de una linea de texo
     * 
     * @param line una linea de texto para leer
     * @param platos un mapa de platos
     * @return el menu que se ha formado al leer la linea
     */
     ...
     * Lee de un fichero
     * 
     * @param nombreFichero el nombre del fichero para leer
     * @return una lista de menu que se han leido del fichero
     */
    ...
    /**
     * Guarda una lista de menus en un fichero
     * 
     * @param nombreFichero el nombre del fichero que se quiere guardar
     * @param menus la lista de menus para guardar
     */
