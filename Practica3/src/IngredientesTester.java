...
public class IngredientesTester{
    /**
     * main que se ejecuta
     * Este metodo imprime la informacion de una serie de ingredientes
     * 
     * @param args No usado
     */
    ...
    /**
     * Crea una serie de ingredientes
     * 
     * @return un mapa de nombre, ingrediente 
     */
    public Map<String, Ingrediente> crearIngredientes(){
        ...
        ingredientes.put("Caldo", new Ingrediente("Caldo", "Caldo", 
